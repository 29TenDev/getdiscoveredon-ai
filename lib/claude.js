...
- SSL/HTTPS confirmed: ${onPage?.hasSSL ? "YES — site is already on HTTPS, do NOT recommend installing SSL" : "NO — site may need SSL"}
...
IMPORTANT RULES:
- If SSL/HTTPS confirmed is "YES", do NOT mention SSL or HTTPS anywhere in the report — it is already handled
- Be specific to their actual data — never generic
- Reference their actual scores, numbers, and competitor situation where relevant
- Write in a professional but approachable tone — like a knowledgeable consultant who genuinely cares about helping this business owner succeed
...
The recommendations array should contain 5 prioritized action items, ordered from highest to lowest impact. Each should be 1-2 sentences, specific and actionable. Do NOT include SSL/HTTPS as a recommendation if SSL is already confirmed present.`;
